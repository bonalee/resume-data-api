...
Experience.create(start_date: 3.years.ago, end_date: 2.years.ago, job_title: "Tightrope walker", company_name: "Cirque du Soleil", details: "Perform walking across circus 50 ft in the air.  Managed & surpassed customer fears & expectations.", student_id: 1)

Experience.create(start_date: 25.months.ago, end_date: 6.months.ago, job_title: "Sword Swallower", company_name: "PT Barnum & Bailey Circuis", details: "Swallow Swords", student_id: 2)

Experience.create(start_date: 20.months.ago, end_date: Time.now, job_title: "Ninja", company_name: "Teenage Mutant Turtles", details: "Fight crime.  Eat Pizza.", student_id: 3)

Experience.create(start_date: 18.months.ago, end_date: Time.now, job_title: "Ice Cream Taster", company_name: "Dippin Dots", details: "Taste 200 samples of ice cream per day without getting brain freeze.", student_id: 4)
